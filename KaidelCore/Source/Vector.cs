...
namespace KaidelCore
{
	...
	internal struct Vector2_Impl
	{
		...
		internal Vector2_Impl(float x, float y, float z)
		{
			this.m_X = x;
			this.m_Y = y;
			this.m_Z = z;
	...
	public struct Vector2
	{
		...
		{
			m_Vector = new Vector2_Impl(x, y, z);
			m_Magnitude = 0.0f;
			RecalcLength();
		}
	...
	{
		internal float m_X, m_Y, m_Z;
		internal Vector4_Impl(float x, float y, float z)
		{
			this.m_X = x;
			this.m_Y = y;
			this.m_Z = z;
	...
	public struct Vector4
	{
		...
		{
			m_Vector = new Vector4_Impl(x, y, z);
			m_Magnitude = 0.0f;
			RecalcLength();
		}
