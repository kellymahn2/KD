...
namespace KaidelCore
{
	...
	internal static partial class Internals
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal extern static void Entity_GetPosition(ulong id, out Vector3 translation);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal extern static void Entity_SetPosition(ulong id, ref Vector3 translation);
		[MethodImpl(MethodImplOptions.InternalCall)]
		internal extern static void Entity_GetComponent<T>(ulong id, out T res);
		[MethodImpl(MethodImplOptions.InternalCall)]
	...
	public static class Debug
	{
		...
		{
			Internals.NativeLog($"{v.x},{v.y},{v.z}");
		}
	}
}
